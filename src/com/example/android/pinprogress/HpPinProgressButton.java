...
public class HpPinProgressButton extends CompoundButton {
	private int mMax;
	...
	public HpPinProgressButton(Context context) {
		super(context);
		init(context, null, 0);
	}

	public HpPinProgressButton(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context, attrs, 0);
	}

	public HpPinProgressButton(Context context, AttributeSet attrs, int defStyle) {
